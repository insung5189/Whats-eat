...
set category_name  = '한식';
insert into category
set category_name  = '양식';
insert into category
set category_name  = '중식';
insert into category
set category_name  = '일식';
insert into category
set category_name  = '퓨전';
insert into category
set category_name  = '공지(관리자용)';
...
#튜플 정보 수정시에 사용
UPDATE category
SET category_name = '한식' WHERE id = 5;
